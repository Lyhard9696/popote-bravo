...
## V6.10.4 — Classement sans doublons

- Suppression de la carte « Ma position ».
- La ligne du membre connecté reste mise en évidence en jaune.
...
## V6.11.1 — Correctif panier

- Le mini-panier réapparaît correctement dès qu'une quantité est supérieure à 0.
- Le bouton de validation est visible au-dessus de la navigation mobile.
- Libellé explicite : « Ajouter à mon ardoise ».
- Les animations V6.11 restent conservées.


## V6.11.2 — Correctif panier fixe iPhone

- Correction de la cause réelle du mini-panier invisible sur Safari/iPhone.
- Suppression du `transform` persistant sur le conteneur principal de l'accueil.
...
## V6.12.4 — Navigation Premium compacte

- Barre de navigation mobile plus fine et moins imposante.
- Conservation du style noir/doré avec icônes en contour.
- Icônes et libellés légèrement réduits pour un rendu plus haut de gamme.
- Panier remonté proprement au-dessus de la navigation.
...
## V6.12.7 — Logo propre + photos persistantes

- Nouveau `static/insigne-bravo-rond.png` avec transparence réelle.
- Le header utilise ce vrai médaillon rond, sans carré noir.
- Les nouvelles photos produits sont stockées directement dans SQLite.
- Elles survivent donc aux redéploiements Render.
- Les anciennes photos basées sur `image_path` restent compatibles.
- Une route `/product-image/<id>` sert les images stockées en base.


## V6.12.8 — Correctif final logo header

- Suppression du fond carré du conteneur du logo.
- Wrapper du logo forcé en fond transparent.
- Médaillon P3 réellement rond et indépendant.
...
## V6.13 — Accueil respirant / sans logo header

- Suppression complète du logo dans le header.
- Conservation de « POPOTE BRAVO » et de la cloche.
- Retour à de vraies marges latérales sur mobile.
- Prénom, introduction, cartes, bouton PayPal, recherche et catalogue alignés dans le même axe.
- Les cartes ne touchent plus les bords de l'écran.
...
## V6.15 — Référence Premium

- Header noir premium avec logo P3, POPOTE blanc, BRAVO doré et cloche à droite.
- Nouveau filigrane P3 doré et discret derrière l'accueil et le classement.
- Retour à trois cartes compte alignées sur une seule ligne.
- Cartes, typographie, ombres, rayons et espacements harmonisés sur la maquette validée.
- Bouton paiement jaune premium avec flèche.
- Recherche avec icône loupe et filtre.
- Catalogue plus compact et mieux aligné.
- Classement : Top 3 encadré, premier en doré, deuxième/troisième distincts.
- Pince du mois avec encadré doré complet.
- QR, Profil, Notifications et Déclarer un paiement harmonisés avec le même langage visuel.
